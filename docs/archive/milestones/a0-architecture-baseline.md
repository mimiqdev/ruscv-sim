...
This is the only current milestone contract. Earlier milestone and sprint plans are historical records under [`archive/`](..). Historical plans do not direct current work; this document defines the current technical scope and acceptance criteria.
