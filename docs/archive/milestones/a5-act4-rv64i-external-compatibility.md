...
> Archived A5 contract snapshot, prepared for closeout on 2026-09-15.
...
[A4 closeout](a4-closeout-record.md) records completed
...
[superseded M8 plan](m8-act4-rv64i-superseded.md).
...
[A4's assessment](a4-capability-assessment.md#one-successor-proposal-act4-rv64i-external-compatibility-validation)
