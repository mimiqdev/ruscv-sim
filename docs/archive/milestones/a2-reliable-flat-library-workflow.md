...
The maintainer accepted A2 with its documented limitations and approved A3, one
shared image-placement and result-construction path behind both public entry
points. The [A2 closeout record](a2-closeout-record.md) holds the criterion
dispositions, verification and limitations, and the
[A2 capability assessment](a2-capability-assessment.md) holds the full mapping.
[The active plan](../../dev-plan.md) is A3. The full contract text below is
preserved with relocated links; its Active and not-yet-verified statements
...
migration. [A1's closeout](a1-closeout-record.md) and its
