...
- **Time — SO:** each `tick_clock` call increments modeled time by one; the harness calls it after a configured number of instructions or on a waiting step while WFI remains active. This is a deliberate reference-platform policy, not a claim of hardware timing fidelity.
...
Evidence is from Arm's public, non-confidential [Fast Models Reference Guide 11.32, document 100964](https://documentation-service.arm.com/documentation/100964/latest/) and [Fast Models Fixed Virtual Platforms Reference Guide 11.28, document 100966](https://documentation-service.arm.com/documentation/100966/latest/). Section and page references below use those editions.
...
| Arm Fast Models/FVP | Fast Models Guide 11.32, document `100964`; FVP Guide 11.28, document `100966` | Public non-confidential Arm Documentation Service guides |
