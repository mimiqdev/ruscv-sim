...
- [A4 acceptance and closeout](a4-capability-assessment.md) — verified shared run control and installation, exact-head review and final merge evidence; formal acceptance and the detailed A5 ACT4 successor contract remain proposed
