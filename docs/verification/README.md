...
- [A3 capability assessment](a3-capability-assessment.md) — shared image placement and result construction mapped to committed tests, retained differences, limitations and one successor recommendation
