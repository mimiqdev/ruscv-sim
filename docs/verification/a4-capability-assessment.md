...
[A4](../dev-plan.md) requires one internal run-control decision and one image
...
The [A3 retained differences](../archive/milestones/a3-capability-assessment.md#retained-differences-between-the-configurations)
still apply:
...
[guest commands](bare-metal-tests.md) were not run locally. No tools were
...
- [G-03, G-04, G-05, CLI G-06, G-07, G-08, G-09 and G-11](public-behavior-gaps.md)
