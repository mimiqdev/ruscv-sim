...
- [A8 single-Hart atomic/physical convergence candidate contract](proposals/a8-single-hart-atomic-convergence.md) — Draft Stage-1 successor candidate awaiting approval; `dev-plan.md` (A7) remains the sole Current contract until a successor is separately activated.
