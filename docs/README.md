...
4. [Documentation policy](documentation-policy.md) — status, authority, and archival rules.
5. Source code and verified tests — authority for what is implemented today.
