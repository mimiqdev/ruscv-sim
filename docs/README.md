...
- [Post-A7 roadmap proposal](proposals/post-a7-roadmap.md) — Draft planning input; it recommends priorities and dependencies but does not activate a successor contract.
