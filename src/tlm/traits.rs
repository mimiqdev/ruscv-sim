...
use super::{ScTime, TlmError, TlmGenericPayload, TlmPhase, TlmSyncEnum};
...
impl DmiData {
    /// 创建新的 DMI 数据
    pub fn new(dmi_ptr: *mut u8, dmi_size: usize, start_address: u64, end_address: u64) -> Self {
        Self {
            dmi_ptr,
            dmi_size,
...
mod tests {
    ...
    fn test_dmi_data() {
        ...
        let dmi = DmiData::new(data.as_mut_ptr(), data.len(), 0x1000, 0x13FF);
