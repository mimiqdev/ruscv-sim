...
fn test_feq_equal() {
    ...
    ruscv_sim::execute_feq_s(&decoded, &mut state, &mut mem).unwrap();
...
fn test_flt_less() {
    ...
    ruscv_sim::execute_flt_s(&decoded, &mut state, &mut mem).unwrap();
...
fn test_fle_less_or_equal() {
    ...
    ruscv_sim::execute_fle_s(&decoded, &mut state, &mut mem).unwrap();
